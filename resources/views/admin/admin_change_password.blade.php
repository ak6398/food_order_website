...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form action="{{route('admin.password.update')}}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                <div class="mb-3">
                                    <label for="example-text-input @error('old_password') is-invalid @enderror" class="form-label">Old Password</label>
                                ...
                                <div class="mb-3">
                                    <label for="example-text-input @error('new_password') is-invalid @enderror" class="form-label">New Password</label>
