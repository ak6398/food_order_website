...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal"> -->
                        ...
                        <div class="auth-full-page-content d-flex p-sm-5 p-4">
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    @endif
                                        <form class="mt-4 pt-2" action="{{route('admin.password_submit')}}" method="POST">@csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="{{route('admin.login')}}" class="text-muted">Remeber password?</a>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script src="{{asset('backend/assets/libs/metismenu/metisMenu.min.js')}}assets/libs/metismenu/metisMenu.min.js"></script>
