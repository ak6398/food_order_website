...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form action="{{route('client.profile.submit')}}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                <div class="mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mt-3 mt-lg-0">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="photo" type="file"  id="image_id">
                                </div>

                                <div class="mb-3">
                                    
                                    <img id="show_image" src="{{!empty($profileData->photo)?url('upload/client_images/'.$profileData->photo):url('upload/no_image.jpg')}}" alt="" class="rounded-circle p-1 bg-primary" width="120">
                                </div>
                                <div class="mt-4">
